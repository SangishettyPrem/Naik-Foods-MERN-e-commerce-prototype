...
app.use(
  cors({
    origin: (origin, callback) => {
      ...
      if (!origin || /^http:\/\/localhost:(5173|5174|5175|3000)$/.test(origin) || /^http:\/\/127\.0\.0\.1:(5173|5174|5175|3000)$/.test(origin)) {
...
const server = app.listen(PORT, () => {
  console.log(`[Express] Naik Foods Server running in ${process.env.NODE_ENV || 'development'} mode on port ${PORT}`);
});
